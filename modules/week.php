...
$this_area_resolution = $row['1'];
$this_room_name = $row['2'];
$this_room_max = $row['3'];
$this_room_name_des = $row['4'];
$this_statut_room = $row['5'];
$this_moderate_room = $row['6'];
$this_delais_option_reservation = $row['7'];
$this_area_comment = $row['8'];
$this_area_show_comment = $row['9'];
